  ...
  return (
    <div className="card" style={{ padding: "1.1rem" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 8 }}>
        <h2 style={{ margin: 0, fontSize: "1.1rem" }}>Today&apos;s Top Rosters</h2>
        ...
        <ol style={{ margin: 0, paddingLeft: 0, listStyle: "none", display: "grid", gap: 6 }}>
          {rows.map((r, i) => (
            <li key={i} style={{ display: "flex", gap: 10, alignItems: "center", fontSize: ".88rem" }}>
              ...
              <span style={{ fontFamily: "var(--font-cond)", color: "var(--accent-2)" }}>{r.score}–{GAMES - r.score}</span>
            </li>
          ))}
        </ol>
      )}
