...
const SITE = "https://mlb162-0.com";

/**
 * Social share for a drafted roster: builds a roster+record image and offers
...
export default function ShareButtons({ data, caption }: { data: ShareInput; caption: string }) {
  ...
  function file(): File | null {
    return img ? new File([img.blob], "mlb162-0.png", { type: "image/png" }) : null;
  }
  ...
  function download() {
    ...
    a.href = img.url; a.download = "mlb162-0.png"; a.click();
  }
  ...
  return (
    <div style={{ display: "grid", gap: 10, justifyItems: "center" }}>
      {img && (
        ...
        <img src={img.url} alt="Your roster and record" width={150}
